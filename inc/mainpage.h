...
The documentation is divided into modules.
 ...
 \li Display contains the SSD1306 display
 \li EdgeTriggered contains edge-triggered interrupts 
 \li FIFO contains software a first in first out queue
 \li LaunchPad contains software for the LEDs and switches on the LaunchPad
 \li MKII contains software for I2C module, plus devices on MKII
 \li PWM contains software for Pulse width modulation
 \li SPI contains software for synchronous serial communication
 \li ST7735 contains software for ST7735 display
 \li Timer contains software for the hardware times
 \li UART contains software for asynchronous serial communication
*/
